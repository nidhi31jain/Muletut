...
<body>
	<div id="main" class="container-fluid">
		...
		<div id="main-content-single" class="col-xs-12">
			<div class="col-md-offset-1 col-md-10 col-xs-12" id="post">
				<div id="post-area" class="row">
					<div id="heading" class="col-xs-12">
						<h2 class="title">10+ Angular 2 and WordPress Integrations
							Examples</h2>
					</div>
					<div id="post-content" class="col-xs-12">What is Lorem Ipsum?
